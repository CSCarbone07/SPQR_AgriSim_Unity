...
namespace RosSharp.RosBridgeClient
{
    public class ImagePublisher : Publisher<Messages.Sensor.CompressedImage>
    {
        ...
        {
            sendPos = new Vector3(ImageCamera.transform.position.x, ImageCamera.transform.position.z, ImageCamera.transform.position.y );
            message.header.frame_id = sendPos.ToString("F3");
