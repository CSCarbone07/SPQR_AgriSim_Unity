...
public class SaveImage : MonoBehaviour
{
    ...
    public void TakeScreenshot()
    {
        ...
        string filename = string.Format("{0}/Dataset/{1}.png", Application.persistentDataPath, counter);
        System.IO.File.WriteAllBytes(filename, bytes);


        //filename = string.Format("{0}/Dataset/LocationAndRotations.png", Application.persistentDataPath);
        filename = string.Format("{0}/Dataset/{1}.txt", Application.persistentDataPath, counter);
