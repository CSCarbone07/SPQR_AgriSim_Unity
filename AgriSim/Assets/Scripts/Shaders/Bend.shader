    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv1 = v.texcoord1;
                o.uv2 = v.texcoord2;
				//v.vertex.xyz += _plantBend;
				//o.vertex = v.vertex;
				//v.vertex.xyz += v.normal.xyz + _plantBend;
				v.vertex.xyz = v.vertex.xyz + ((1-(pow(o.uv0.y, _bendOffset)))*(pow(o.uv0.y, _bendOffset)) * _plantBend) + _positionOffset;
